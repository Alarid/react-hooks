...
Having a value stored in react state will tell React to re-render the component
when this state value changes. If we don't use state and store the value in a
variable, the function component will not be re-render if this variable changes.
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Hooks%20%F0%9F%8E%A3&e=01%3A%20useState%3A%20greeting&em=yoh.legrand%40gmail.com).
