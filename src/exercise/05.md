...
`React.useRef` is usefull to access DOM nodes after render. We can mutate the
`current` prop on a ref without triggering a re-render.
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Hooks%20%F0%9F%8E%A3&e=05%3A%20useRef%20and%20useEffect%3A%20DOM%20interaction&em=yoh.legrand%40gmail.com).
